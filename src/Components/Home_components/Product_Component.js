      ...
      <Container className="product-card my-box-shadow p-1 rounded-lg">
        ...
        <div className="col-12">
          <div className="row mt-2 mb-1">
            <div className="col-6 d-flex flex-end align-items-center">
              <h3>{name}</h3>
            </div>
            <div className="col-6 d-flex flex-end align-items-center justify-content-end">
              <Container className="d-flex pl-3 flex-end align-items-center justify-content-end">
                <h6>{forma_currency(price)}</h6>
              </Container>
            </div>
          </div>
          <div className="row produdct-btns mb-4 mt-2">
            {quantityInCart === 0 ? (
              ...
              <>
                <Row className="w-100 mb-2 ml-0 mr-0 d-flex align-items-center justify-content-around">
                  <div className="col-4 w-auto  d-flex align-items-center justify-content-around">
                    <Button
                      onClick={() => {
                        increaseItemsQuantity(id);
                      }}
                  ...
                  <div className="col-4 w-auto d-flex align-items-center justify-content-around">
                    <div className="btn">{quantityInCart}</div>
                  </div>
                  <div className="col-4 w-auto p-0 d-flex align-items-center justify-content-around">
                    <Button
                      onClick={() => {
                ...
                <Row className="w-100 mb-2 ml-0 mr-0 d-flex align-items-center justify-content-around">
                  <Button
                    ...
                    className="btn-dang my-box-shadow w-50 m-0"
                  >
                    <h6>
                      <span>إزالة</span>
                    </h6>
